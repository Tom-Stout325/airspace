...
class PilotProfileTests(TestCase):
    def setUp(self):
        ...
        PilotProfile.objects.create(user=self.other_user, license_number="OTHER-123")
    ...
    def test_profile_create_and_update(self):
        response = self.client.post(reverse("pilot:profile_edit"), {"first_name":"Patricia","last_name":"Pilot","business_name":"Sky LLC","email":"pilot@example.com","street_address":"123 Main St","city":"Westfield","state":"in","zip_code":"46074","phone":"317-555-0100","license_number":"FAA-123"})
    ...
    def test_profile_delete_does_not_delete_login_account(self):
        PilotProfile.objects.create(user=self.user, license_number="FAA-123")
