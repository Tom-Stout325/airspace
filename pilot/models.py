...
def pilot_logo_upload_path(instance, filename):
    extension = Path(filename).suffix.lower()
    return f"pilot_logos/{instance.user_id}/company_logo{extension}"
...
class PilotProfile(models.Model):
    ...
    company_logo = models.ImageField(
        upload_to=pilot_logo_upload_path,
        blank=True,
        validators=[
    ...
    def flight_time_total(self):
        ...
        return int(
            Decimal(self.total_flight_hours) * Decimal("3600")
        )
